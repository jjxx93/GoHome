...
//
//        Face face1 = FaceppUtils.detect(urlA);
//        List<String> list = losterService.getUrl(face1.getMinAge(), face1.getMaxAge(), face1.getGender());
//        int length = list.size();
//
//        for (int i = 0; i < length; i++) {
//            Face face2 = FaceppUtils.detect(list.get(i));
